...
API_ID = os.environ.get('API_ID', 2566765)
API_HASH = os.environ.get('API_HASH', 'de1b01834ac0a3b3b6d36f5e0937e99e')
BOT_TOKEN = os.environ.get('BOT_TOKEN', '1836422837:AAErcVgq_qnG8xi3wwECjBtiyf5x4DZShGc')
TESTMODE = os.environ.get('TESTMODE')
TESTMODE = TESTMODE and TESTMODE != '0'

EVERYONE_CHATS = os.environ.get('EVERYONE_CHATS')
EVERYONE_CHATS = list(map(int, EVERYONE_CHATS.split(' '))) if EVERYONE_CHATS else [-1001437939580]
ADMIN_CHATS = os.environ.get('ADMIN_CHATS')
ADMIN_CHATS = list(map(int, ADMIN_CHATS.split(' '))) if ADMIN_CHATS else [1311263911]
